...
const toastManagerBase = Toast.createToastManager();
const addToast = toastManagerBase.add.bind(toastManagerBase);
toastManagerBase.add = (toast) => {
...
export const toastManager: ReturnType<typeof Toast.createToastManager> = toastManagerBase;
